...
import { Store, Sparkles, Shield, TrendingUp, ArrowRight } from "lucide-react";

const features = [
    { icon: Store, title: "Professional presence", desc: "Create a website that looks like it cost thousands — without the agency price tag." },
    { icon: Sparkles, title: "AI does the heavy lifting", desc: "Just describe your business and Struxly creates a tailored website in minutes." },
    { icon: Shield, title: "Secure & reliable", desc: "Enterprise-grade hosting with SSL, automatic backups, and 99.9% uptime guarantee." },
    { icon: TrendingUp, title: "Grow with confidence", desc: "Built-in SEO tools and analytics help you attract and convert more customers." },
];
        ...
        <div className="min-h-screen bg-white">
            ...
            <section className="pt-24 pb-16 px-6 text-center">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 text-emerald-600 text-[12px] font-semibold mb-6">
                        <Store className="w-3.5 h-3.5" /> For Small Businesses
                    </div>
                    <h1 className="text-[42px] font-bold text-gray-900 leading-tight mb-4">Your business deserves a great website</h1>
                    <p className="text-[17px] text-gray-500 max-w-[520px] mx-auto mb-8">No technical skills needed. Tell Struxly what you want and get a professional website that grows with your business.</p>
